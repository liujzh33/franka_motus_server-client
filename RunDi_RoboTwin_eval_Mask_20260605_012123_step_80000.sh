#!/bin/bash
# Eval script: timestamp 20260605_012123, checkpoint checkpoint_step_80000
...
# Download checkpoint: 20260605_012123, checkpoint_step_80000
CKPT_OBS="obs://yw-2030-gy/external/wwx1484778/cache-DI/20260605_012123/checkpoints/robotwin_wan_vlm_mask_stage2/motus_wan_vlm_robotwin_bs10_lr5e-05/checkpoint_step_80000/pytorch_model"
CKPT_LOCAL="/cache/wwx1513998/pretrained_models/ckpt_step80000_012123/pytorch_model"
mkdir -p "$CKPT_LOCAL"
...
if [ -n "$LOG_DIR" ]; then
    ...
    OBS_LOG_PATH="obs://yw-2030-gy/external/wwx1513998/eval_logs/20260605_012123_checkpoint_step_80000/$LOG_BASENAME"
...
python -c "print('Well Done. Eval 20260605_012123_checkpoint_step_80000 completed.')"
