...
if __name__ == "__main__":
    # 要下载的目录列表
    folders_to_download = [
        "checkpoints/pretrain_human_robot_mixed/pretrain_human_robot_mixed/checkpoint_step_80000/pytorch_model/mp_rank_00_model_states.pt"

    ]
    obs_base_dir = "obs://yw-2030-gy/external/wx1469573/cache-DI/20260515_113647/"
    local_base_dir = "/cache/wwx1484778/motus_weights/train_log"
