#!/usr/bin/env python3
"""WebSocket client for Franka Motus inference server."""
...
def run_once(
    ...
    t5_embeddings_path: Optional[str],
...
def build_argparser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Franka Motus WebSocket inference client")
    parser.add_argument("host", help="Server host, e.g. 127.0.0.1")
    parser.add_argument("--port", type=int, default=18090, help="Server port")
    ...
    parser.add_argument("--state_csv", type=str, default=None, help="7-dim Franka state csv")
    parser.add_argument("--t5_embeddings_path", type=str, default=None, help="Optional T5 .pt path")
...
def main() -> int:
    ...
    if args.mock:
        result = run_once(args.host, args.port, None, None, None, None, None, msg_type="mock", timeout=args.timeout)
    ...
    if images_b64 is None and args.image is None:
        images_b64 = [_create_random_image_base64(), _create_random_image_base64(), _create_random_image_base64()]
