...
python -c "import moxing as mox; mox.file.copy_parallel('obs://yw-2030-gy/external/wwx1484778/code/Motus/', '/cache/wx1513998/Motus/')"
echo "--------------- copy code done ---------------"
...
# ===== Background upload disabled (DI platform does not allow sleep) =====
