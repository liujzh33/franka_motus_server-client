#!/bin/bash
# Eval script: timestamp 20260605_083430, checkpoint best_action_l2
...
# Download checkpoint: 20260605_083430, best_action_l2
CKPT_OBS="obs://yw-2030-gy/external/wwx1484778/cache-DI/20260605_083430/checkpoints/robotwin_wan_vlm_mask_stage2/motus_wan_vlm_robotwin_bs10_lr5e-05/best_action_l2/pytorch_model"
CKPT_LOCAL="/cache/wwx1513998/pretrained_models/ckpt_best_action_l2_083430/pytorch_model"
mkdir -p "$CKPT_LOCAL"
...
if [ -n "$LOG_DIR" ]; then
    ...
    OBS_LOG_PATH="obs://yw-2030-gy/external/wwx1513998/eval_logs/20260605_083430_best_action_l2/$LOG_BASENAME"
...
python -c "print('Well Done. Eval 20260605_083430_best_action_l2 completed.')"
