...
def evaluate_model(model, dataloader, accelerator, config, num_eval_batches: int = 2) -> Dict[str, float]:
    ...
    # Unwrap model from DDP/accelerator wrapper to access inference_step
    ...
    for step, batch in enumerate(dataloader):
        ...
        # Inference - use unwrapped model
        predicted_frames, predicted_actions = inference_sample(unwrapped_model, batch, config)
